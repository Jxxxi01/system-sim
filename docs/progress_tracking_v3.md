...
| 编号 | 事项 | 优先级 | 状态 | 说明 |
|------|------|--------|------|------|
| I-1 | SecureIR工具链（签名+序列化） | 高 | ⏳ | C/C++，对应paper_plan I5 |
| I-2 | Gateway模拟器 | 高 | ⏳ | C/C++，对应paper_plan I1 |
| I-3 | EWC模拟器 | 高 | ⏳ | C/C++ |
| I-4 | PVT模拟器 | 高 | ⏳ | C/C++ |
| I-5 | SPE模拟器 | 高 | ⏳ | C/C++ |
| I-6 | 简单CPU模拟循环 | 高 | ⏳ | C/C++，Fetch→Decode→Execute→Memory |
| I-7 | 5个演示场景 | 高 | ⏳ | 正常执行/代码注入/跨用户/ROP/跨进程 |
...
| progress_tracking_v3_new.md | 2026-03-01 | 当前文档，含图/PPT（含攻防数据可视化）/Demo规划 |
